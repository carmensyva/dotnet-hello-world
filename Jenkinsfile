pipeline {
    ...
    environment {
        ...
        PROJECT_NAME = "dotnet"
        REPO_URL = "github.com/carmensyva/dotnet-hello-world.git"
        BRANCH_NAME = "master"
        LANGUAGE = "dotnet"
        ...
        HOSTED_REPO_URL = "http://nexus-service.nexus.svc.cluster.local:8081/repository/mib-nugat-hosted/"
        SONAR_HOST_URL = "http://sonar.sonarqube.svc.cluster.local:9000"
            ...
            steps {
                dir("source") {
                    script {
                        ...
                        sh "cp -r publish/* build-folder/apps/"
